 ...
 *
 */
class WheelEncodersDataPlugin : public plugin::PluginBase {
public:
	EIGEN_MAKE_ALIGNED_OPERATOR_NEW

	WheelEncodersDataPlugin() : PluginBase(),
		wo_nh("~wheel_encoders_data"),
		count(0),
		odom_mode(OM::NONE),
		raw_send(false),
		twist_send(false),
...
PLUGINLIB_EXPORT_CLASS(mavros::extra_plugins::WheelEncodersDataPlugin, mavros::plugin::PluginBase)
